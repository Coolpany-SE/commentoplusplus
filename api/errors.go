...
var errorAlreadyModerator = errors.New("Already a moderator.")
...
var errorDomainOwnerAlreadyExists = errors.New("This owner is already associated with this domain.")
var errorCannotRemoveLastOwner = errors.New("Cannot remove the last owner of a domain. Delete the domain instead, or add another owner first.")
